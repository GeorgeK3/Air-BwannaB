...
public class RenterRateActivity extends AppCompatActivity implements RoomRateAdapter.OnRoomClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("HELLO THERE","INSIDE RENTER RATE ACTIVITY");
    ...
    private void loadRooms() {
        new Thread(() -> {
            Client cl;
            try {
                cl = new Client(new JSONObject(), "getUser",RenterLoginActivity.renterID);
            ...
            if (jsonArray == null || jsonArray.length() == 0) {
                runOnUiThread(() -> {
                    Toast.makeText(RenterRateActivity.this, "You have not rented a room yet to leave a rating", Toast.LENGTH_SHORT).show();
                });
                startActivity(new Intent(RenterRateActivity.this, RenterMenuActivity.class));
            } else {
                try {
                    ...
                    runOnUiThread(() -> {
                        roomAdapter = new RoomRateAdapter(roomList, RenterRateActivity.this);
    ...
    public void onRoomClick(Room room) {
        Intent intent = new Intent(RenterRateActivity.this, RoomDetailRateActivity.class);
